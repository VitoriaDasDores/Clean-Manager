...
const Dashboard = () => {
  ...
  const prepareChartData = (data) => {
    ...
    const taskDistributionData = [
      ...
      { status: "Em progresso", count: taskDistribution?.InProgress || 0 },
      { status: "Completo", count: taskDistribution?.Completed || 0 },
    ];
    ...
    <DashboardLayout activeMenu="Dashboard">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 my-4 md:my-6">
        ...
        <div>
          <div className="card">
            <div className="flex items-center justify-between">
              <h5 className="font-medium">Nivel de prioridade de tarefas</h5>
            </div>
